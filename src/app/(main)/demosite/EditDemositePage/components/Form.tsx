...
export const Form = ({
    ...
    (e: React.DragEvent<HTMLDivElement>, isHeaderDrop = false) => {
      ...
      if (isHeaderDrop) {
        ...
        if (validFiles.length > 0) {
          const headerFile = validFiles[0];
          setHeaderPhoto(headerFile);
          setValue('header', headerFile);
        }
      } else {
        const validTypes = [
          'image/jpeg',
  ...
  const onSubmit = async (data: DemositeFormData) => {
    ...
    try {
      ...
      handleSubmitCancel();
      toast.error('Failed to update demosite. Please try again.');
  ...
  return (
    <div>
              ...
              <Box sx={{ mt: 2 }}>
                ...
                >
                  ...
                  <IconButton
                    onClick={() => {
                      setHeaderPhoto(null);
                      setValue('header', undefined as unknown as File);
                    }}
                    size="small"
                    sx={{ color: '#EF4444' }}
                  >
      ...
      <ConfirmationModal
        ...
        title="Update these changes?"
        message="Ready to save your changes? Just click 'Confirm' to update the demosite."
